...
public class SimonSaysRecipe extends KeyAdapter {
 ...
 JOptionPane.showMessageDialog(null, "Only press the correct key if Simon said so");
...
getNextRandomImage();
	...
	if(n == simonSays){
		speak("Simon dice presiona la tecla");
	}
	else{
		speak("Presiona esta tecla");
	}
	}
