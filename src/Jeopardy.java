...
public class Jeopardy implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (buttonPressed == firstButton) {
			askQuestion("who is the lead guitar for Guns N Roses?", "Slash", 200);
		}
		// Call the askQuestion() method
		if (buttonPressed == secondButton) {
			askQuestion("what is the name of the song in New Orleans by The Animals?", "The House of the Rising Sun",
					400);
		}
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		// Otherwise
			...
			score -= prizeMoney;
			JOptionPane.showMessageDialog(null, "wrong, its Slash");
			updateScore();
		}
